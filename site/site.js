  ...
  function buildFooter(){
    ...
    return '<footer class="foot"><div class="wrap">'+
      '<div class="foot__grid">'+
        ...
        '</div>'+
      '</div>'+
      '<div class="foot__bot"><span>© 2026 Vahini Technologies · vahinitech.com · <a href="https://github.com/vahinitech/20factor-analyser" target="_blank" rel="noopener" style="color:inherit;text-decoration:underline;text-underline-offset:2px;">Open source (AGPL-3.0)</a> · <a href="'+P("licenses.html")+'" data-nav style="color:inherit;text-decoration:underline;text-underline-offset:2px;">Licenses</a> · <a href="#" onclick="VahiniOpenCookieSettings&&VahiniOpenCookieSettings();return false;" style="color:inherit;text-decoration:underline;text-underline-offset:2px;">Cookie settings</a></span>'+
